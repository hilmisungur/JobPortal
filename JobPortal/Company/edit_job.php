...
$jid = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : null;
...
// İlgili işe sadece kendi UID'si ile erişebilir
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $conn->prepare("UPDATE Job SET Title = ?, JobType = ?, JLocation = ?, Description = ? WHERE JID = ? AND UID = ?");
    $update->bind_param("ssssii", $title, $type, $location, $description, $jid, $uid);
